...
export function AddReviewForm({ employer, id }: AddReviewFormProps) {
  ...
  return (
    <div id={id} className="bg-white rounded-lg shadow-sm p-6">
      <h3 className="text-xl font-semibold mb-4">Dodaj opinię</h3>
      ...
      {!showForm ? (
        <div className="text-center">
          <p className="text-gray-600 mb-4">
            Podziel się swoim doświadczeniem z {employer.name}
          </p>
          <button
